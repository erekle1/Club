...
<head>
    ...
    <meta name="description" content="OneUI - admins Dashboard Template & UI Framework created by pixelcave and published on Themeforest">
    ...
    <link rel="shortcut icon" href="admins/img/favicons/favicon.png">

    <link rel="icon" type="image/png" href="admins/img/favicons/favicon-16x16.png" sizes="16x16">
    <link rel="icon" type="image/png" href="admins/img/favicons/favicon-32x32.png" sizes="32x32">
    <link rel="icon" type="image/png" href="admins/img/favicons/favicon-96x96.png" sizes="96x96">
    <link rel="icon" type="image/png" href="admins/img/favicons/favicon-160x160.png" sizes="160x160">
    <link rel="icon" type="image/png" href="admins/img/favicons/favicon-192x192.png" sizes="192x192">

    <link rel="apple-touch-icon" sizes="57x57" href="admins/img/favicons/apple-touch-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="60x60" href="admins/img/favicons/apple-touch-icon-60x60.png">
    <link rel="apple-touch-icon" sizes="72x72" href="admins/img/favicons/apple-touch-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76" href="admins/img/favicons/apple-touch-icon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114" href="admins/img/favicons/apple-touch-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120" href="admins/img/favicons/apple-touch-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144" href="admins/img/favicons/apple-touch-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152" href="admins/img/favicons/apple-touch-icon-152x152.png">
    <link rel="apple-touch-icon" sizes="180x180" href="admins/img/favicons/apple-touch-icon-180x180.png">
    <!-- END Icons -->
    ...
    <!-- Page JS Plugins CSS -->
    <link rel="stylesheet" href="admins/js/plugins/slick/slick.min.css">
    <link rel="stylesheet" href="admins/js/plugins/slick/slick-theme.min.css">

    <!-- OneUI CSS framework -->
    <link rel="stylesheet" id="css-main" href="admins/css/oneui.css">

    <!-- You can include a specific file from css/themes/ folder to alter the default color theme of the template. eg: -->
    <!-- <link rel="stylesheet" id="css-theme" href="admins/css/themes/flat.min.css"> -->
    <!-- END Stylesheets -->
</head>
<body>
<!-- Page Container -->
            ...
            <div class="side-header side-content">
                ...
                <button class="btn btn-default pull-right" type="button" data-toggle="layout" data-action="side_overlay_close">
                    <i class="fa fa-times"></i>
                        ...
                        <span>
                            <img class="img-avatar img-avatar32" src="admins/img/avatars/avatar10.jpg" alt="">
                    ...
                    <div class="block-content">
                        ...
                        <ul class="list list-activity">
                            <li>
                                ...
                                <div><a href="javascript:void(0)">admins Template</a></div>
                        ...
                        <ul class="nav-users">
                            <li>
                                <a href="base_pages_profile.html">
                                    <img class="img-avatar" src="admins/img/avatars/avatar4.jpg" alt="">
                            ...
                            <li>
                                <a href="base_pages_profile.html">
                                    <img class="img-avatar" src="admins/img/avatars/avatar10.jpg" alt="">
                            ...
                            <li>
                                <a href="base_pages_profile.html">
                                    <img class="img-avatar" src="admins/img/avatars/avatar6.jpg" alt="">
                            ...
                            <li>
                                <a href="base_pages_profile.html">
                                    <img class="img-avatar" src="admins/img/avatars/avatar1.jpg" alt="">
                ...
                <div class="side-header side-content bg-white-op">
                    ...
                    <div class="btn-group pull-right">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right font-s13 sidebar-mini-hide">
                            ...
                            <li>
                                <a data-toggle="theme" data-theme="admins/css/themes/amethyst.min.css" tabindex="-1" href="javascript:void(0)">
                                    <i class="fa fa-circle text-amethyst pull-right"></i> <span class="font-w600">Amethyst</span>
                                </a>
                            </li>
                            <li>
                                <a data-toggle="theme" data-theme="admins/css/themes/city.min.css" tabindex="-1" href="javascript:void(0)">
                                    <i class="fa fa-circle text-city pull-right"></i> <span class="font-w600">City</span>
                                </a>
                            </li>
                            <li>
                                <a data-toggle="theme" data-theme="admins/css/themes/flat.min.css" tabindex="-1" href="javascript:void(0)">
                                    <i class="fa fa-circle text-flat pull-right"></i> <span class="font-w600">Flat</span>
                                </a>
                            </li>
                            <li>
                                <a data-toggle="theme" data-theme="admins/css/themes/modern.min.css" tabindex="-1" href="javascript:void(0)">
                                    <i class="fa fa-circle text-modern pull-right"></i> <span class="font-w600">Modern</span>
                                </a>
                            </li>
                            <li>
                                <a data-toggle="theme" data-theme="admins/css/themes/smooth.min.css" tabindex="-1" href="javascript:void(0)">
            ...
            <li>
                <div class="btn-group">
                    <button class="btn btn-default btn-image dropdown-toggle" data-toggle="dropdown" type="button">
                        <img src="admins/img/avatars/avatar10.jpg" alt="Avatar">
...
<script src="admins/js/core/jquery.min.js"></script>
<script src="admins/js/core/bootstrap.min.js"></script>
<script src="admins/js/core/jquery.slimscroll.min.js"></script>
<script src="admins/js/core/jquery.scrollLock.min.js"></script>
<script src="admins/js/core/jquery.appear.min.js"></script>
<script src="admins/js/core/jquery.countTo.min.js"></script>
<script src="admins/js/core/jquery.placeholder.min.js"></script>
<script src="admins/js/core/js.cookie.min.js"></script>
<script src="admins/js/app.js"></script>

<!-- Page Plugins -->
<script src="admins/js/plugins/slick/slick.min.js"></script>
<script src="admins/js/plugins/chartjs/Chart.min.js"></script>

<!-- Page JS Code -->
<script src="admins/js/pages/base_pages_dashboard.js"></script>
<script>
    $(function () {
